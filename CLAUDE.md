...
**ปิดงานแล้ว (16 ก.ค. 2569):** เช็คเอาต์ตอนเย็น ไม่บังคับ (P1.4, migration 31) — backend+frontend+E2E test+push ขึ้น git สำเร็จครบทั้งหมด ดูข้อ 33 — **Grace Card (P1.3) ยังไม่เริ่ม รอเจ้าของตัดสินใจเรื่องการจัดกลุ่มเจ้าหน้าที่ที่เหลือ (11/20 คนยังไม่มี work_group) ก่อน**
...
- Grace Card (P1.3) — ดีไซน์ร่างไว้แล้วใน roadmap ยังไม่เขียนโค้ด — ติดเงื่อนไขเดียวกับ badge ทีม OT (P1.1) คือต้องพึ่ง `work_group` แต่ยังมีเจ้าหน้าที่ 11/20 คนไม่มีกลุ่ม เจ้าของยังไม่ตัดสินใจว่าจะจัดกลุ่มยังไง (คุยกันแล้วว่ากลุ่ม 1 คนก็ใช้งานได้ปกติ ไม่กระทบ schema เดิม แต่ยังไม่ได้ข้อสรุปสุดท้าย)
