...
เจ้าของตรวจไฟล์ผ่าน `present_files` แล้วสั่ง "push เลย" — sync ไฟล์ที่แก้ทั้งหมด (`index.html`, `dashboard.html`